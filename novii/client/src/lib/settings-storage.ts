...
function dbRowToSettings(row: any): UserSettings {
  return {
    ...
    content: { show_suggested: row.show_suggested ?? true, show_trending: row.show_trending ?? true, sensitive_content: row.sensitive_content ?? false },
...
function settingsToDbRow(s: UserSettings) {
  return {
    ...
    show_suggested: s.content.show_suggested,
    show_trending: s.content.show_trending,
    sensitive_content: s.content.sensitive_content,
