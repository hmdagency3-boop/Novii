...
export function PostCommentsSheet({ postId, open, onClose }: PostCommentsSheetProps) {
    ...
    <Sheet open={open} onOpenChange={(v) => { if (!v) onClose(); }}>
      <SheetContent
        ...
        className={cn(
          ...
          isMobile ? "h-[70vh] rounded-t-2xl" : "w-[380px] h-full top-0",
          isRTL && "dir-rtl"
        )}
      >
        <div className="w-10 h-1 bg-muted-foreground/30 rounded-full mx-auto mt-2 md:hidden" />
