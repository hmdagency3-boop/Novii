  ...
  return (
    <div className="p-6 space-y-4" dir="rtl">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-[22px] font-semibold text-[#262626]">إدارة المجتمعات</h1>
      ...
      <div className="flex items-center gap-3 flex-wrap">
        <div className="relative flex-1 min-w-[280px]">
          ...
          <input
            ...
            className="w-full pr-10 pl-4 py-2.5 bg-white border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#0095f6]/20 focus:border-[#0095f6]/40 transition-all"
            dir="rtl"
          />
        </div>
          ...
          {(["all", "public", "private"] as const).map((f) => (
            <button
              ...
              className={`px-3.5 py-1.5 rounded-lg text-xs font-medium transition-all ${
                filter === f ? "bg-[#0095f6] text-white shadow-sm" : "text-gray-500 hover:text-gray-700 hover:bg-gray-50"
              }`}
            >
                  ...
                  <tr key={community.id} className="hover:bg-gray-50/50 transition-colors">
                    <td className="px-5 py-3.5">
                      <div className="flex items-center gap-3">
                        <div className="w-9 h-9 rounded-full bg-gradient-to-br from-[#833AB4] via-[#E1306C] to-[#F77737] flex items-center justify-center text-white text-sm font-bold shrink-0 overflow-hidden">
                    ...
                    <td className="px-5 py-3.5">
                      <div className="flex items-center justify-center gap-1">
                        <button
                          ...
                          className="p-1.5 rounded-lg hover:bg-blue-50 text-gray-400 hover:text-[#0095f6] transition-colors"
                          title="إدارة المجتمع"
                        >
...
function Avatar({ url, name, size = "md" }: { url?: string | null; name: string; size?: "sm" | "md" | "lg" }) {
  ...
  return (
    <div className={`${sizeClass} rounded-full bg-gradient-to-br from-[#833AB4] via-[#E1306C] to-[#F77737] flex items-center justify-center text-white font-bold shrink-0 overflow-hidden`}>
            ...
            <div className="min-w-0">
              ...
              <div className="flex items-center gap-1.5 mt-1.5">
                ...
                <div className="flex items-center gap-1 bg-blue-50 border border-blue-100 rounded-lg px-2 py-0.5">
                  <span className="text-xs font-mono font-bold text-[#0095f6] tracking-widest" dir="ltr">
...
function MembersTab({ community, onRefresh }: { community: CommunityRecord; onRefresh: () => void }) {
  ...
  const roleConfig: Record<string, { label: string; color: string }> = {
    admin: { label: "أدمن", color: "text-[#0095f6] bg-blue-50" },
                      ...
                      {!isCreator && (
                        <div className="relative">
                          <select
                            ...
                            className="appearance-none text-[11px] font-medium px-2 py-0.5 rounded-lg border border-gray-200 bg-white text-gray-600 cursor-pointer focus:outline-none focus:ring-1 focus:ring-[#0095f6] disabled:opacity-50 pl-5"
                          >
  ...
  return (
    <div dir="rtl">
      ...
      <div className="px-5 pt-4 pb-3 border-b border-gray-100 sticky top-0 bg-white z-10">
        <p className="text-[11px] font-semibold text-[#0095f6] mb-2 flex items-center gap-1.5">
        ...
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 px-3 py-2 rounded-xl border border-gray-200 text-sm bg-gray-50 focus:outline-none focus:ring-2 focus:ring-[#0095f6]/30 focus:border-[#0095f6]/40 placeholder:text-gray-400"
            dir="rtl"
          />
          <button
            onClick={handleSend}
            disabled={sending || !msgInput.trim()}
            className="px-3 py-2 rounded-xl bg-[#0095f6] text-white hover:bg-[#1877f2] disabled:opacity-50 disabled:cursor-not-allowed transition-colors shrink-0 flex items-center gap-1.5 text-sm font-medium"
          >
            {sending ? (
      ...
      <div className="p-5 space-y-3">
        ...
        {messages.map((msg) => (
          ...
          >
            {msg.is_system_message ? (
              <div className="w-8 h-8 rounded-full overflow-hidden shrink-0 bg-white border border-blue-100">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-baseline gap-2 mb-0.5 flex-wrap">
                {msg.is_system_message ? (
                  <span className="text-xs font-bold text-[#0095f6]">النظام</span>
                ) : (
              ...
              {msg.content && !msg.is_deleted && (
                <p className={`text-sm break-words leading-relaxed ${msg.is_system_message ? "text-[#0095f6] font-medium" : "text-gray-700"}`}>
                  {msg.content}
                </p>
              )}
              {msg.content && msg.is_deleted && (
              ...
              {msg.image_url && !msg.is_deleted && !msg.is_system_message && (
                <a href={msg.image_url} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 mt-1.5 text-xs text-[#0095f6] hover:underline">
